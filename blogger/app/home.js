define(['jquery', 'lib/jquery.isotope'], function ($, isotope) {
  ...
  return {
    ...
    load_more: function () {
      var
        h = "http://3.bp.blogspot.com/-iz_MSJzLKJ4/UYl-et5D0iI/AAAAAAAAJDE/TtbzqCN-45I/s000/ajax-loader.gif",
        i = "",
        b = null,
        a = "div.blog-posts",
        d = false,
      ...
      function c(m) {
        $.getScript("http://" + m + ".disqus.com/blogger_index.js")
      }
      ...
      function l() {
        ...
        i = $("a.blog-pager-older-link").attr("href");
        if (!i) {
          return
        }
        var n = $('<a class="loadpost" href="javascript:;">Load more posts</a>');
        n.click(j);
        var m = $('<img class="imgload" src="' + h + '" style="display: none;">');
        b = $('<div style="text-align: center; font-size: 140%;"></div>');
        b.append(n);
        b.append(m);
        b.insertBefore($("#blog-pager"));
        $("#blog-pager").hide()
      }
    }
  };

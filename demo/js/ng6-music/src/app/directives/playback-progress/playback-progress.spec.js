...
describe('PlaybackProgress', ()=>{
	...
	describe('Directive', ()=>{
			...
			let directive = PlaybackProgressDirective();

			it('should use the right template',()=>{
				expect(directive.template).to.equal(PlaybackProgressTemplate);
			});
			...
			it('should use the right controller', ()=>{
				expect(directive.controller).to.equal(PlaybackProgressController);
			});
	});
});
